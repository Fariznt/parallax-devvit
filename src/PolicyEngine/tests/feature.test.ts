 ...
 * none of 'a' and 'b' in the input text (regex blacklists). 
...
describe('all_of [a,b]', async () => {
  it('violates when both letters present', async () => {
    const result = await allOf('ab');
    expect(result).toBe(true);
  });

  it('violates when x is present', async () => {
    const result = await allOf('xyza');
    expect(result).toBe(true);
  });

  it('violates when y is present', async () => {
 ...
 * any of 'a' and 'b' to NOT be in input text (regex blacklists).
 * Returns true upon violation
 */
...
describe('any_of [a,b]', async () => {
  it('violates when both are present', async () => {
  ...
  it('passes when b not present', async () => {
